...
description: Unit tests with 100% condition coverage for ProductSearchService.convertToDTO method.
---
...
Expected Output: ResProductDTO object with identical values.
Actual Output: ResProductDTO object with identical values.
