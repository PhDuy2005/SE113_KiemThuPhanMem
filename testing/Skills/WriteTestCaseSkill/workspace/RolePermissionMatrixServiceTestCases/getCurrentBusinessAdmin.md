...
description: Unit tests with 100% condition coverage for RolePermissionMatrixService.getCurrentBusinessAdmin method.
---
...
Input: User with accountStatus = "DEACTIVATED".
Expected Output: BusinessException (403, "User account is not active")
Actual Output: BusinessException (403, "User account is not active")
...
void getCurrentBusinessAdmin_NoLogin_ThrowsUnauthorized() {
    try (MockedStatic<SecurityUtil> securityUtilMock = mockStatic(SecurityUtil.class)) {
        ...
        BusinessException exception = assertThrows(BusinessException.class, () -> 
            ReflectionTestUtils.invokeMethod(rolePermissionMatrixService, "getCurrentBusinessAdmin"));
...
void getCurrentBusinessAdmin_ValidAdmin_ReturnsUser() {
    try (MockedStatic<SecurityUtil> securityUtilMock = mockStatic(SecurityUtil.class)) {
        ...
        User result = ReflectionTestUtils.invokeMethod(rolePermissionMatrixService, "getCurrentBusinessAdmin");
