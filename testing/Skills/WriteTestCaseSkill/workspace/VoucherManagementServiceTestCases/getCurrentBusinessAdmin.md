...
description: Unit tests with 100% condition coverage for VoucherManagementService.getCurrentBusinessAdmin method.
---
...
void getCurrentBusinessAdmin_NoLogin_ThrowsUnauthorized() {
    try (MockedStatic<SecurityUtil> securityUtilMock = mockStatic(SecurityUtil.class)) {
        ...
        BusinessException exception = assertThrows(BusinessException.class, () -> 
            ReflectionTestUtils.invokeMethod(voucherManagementService, "getCurrentBusinessAdmin"));
...
void getCurrentBusinessAdmin_ValidAdmin_ReturnsUser() {
    try (MockedStatic<SecurityUtil> securityUtilMock = mockStatic(SecurityUtil.class)) {
        ...
        User result = ReflectionTestUtils.invokeMethod(voucherManagementService, "getCurrentBusinessAdmin");
